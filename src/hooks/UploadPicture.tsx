...
function UploadPicture(
  ...
  async function uploadImageToS3Bucket() {
    ...
    if (status === "success") {
      ...
      setImageUrl(location as string);
    }
        ...
        <FormField
          ...
          render={() => (
            <FormItem className="flex flex-col">
              ...
              {preview && (
                <span
                  className="rounded-md bg-primary p-2 text-primary-foreground z-50  text-center hover:cursor-pointer shadow-xl flex justify-center"
